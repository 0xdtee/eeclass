            ...
            <section className="bg-background-50 border border-background-200 rounded-2xl overflow-hidden">
              ...
              <div className="px-5 pb-4 pt-1 border-t border-background-100">
                ...
                <p className="text-xs text-foreground-400 mt-1 leading-relaxed">
                  {t('默认:每门课一个固定颜色,方便认课。按学分:紫→红→黄→绿→蓝,学分由高到低;同学分的不同课用同色系的深浅区分。')}
                </p>
                ...
                {s.calendarColor === 'credits' && (
                  <div className="flex flex-wrap items-center gap-2 mt-2.5">
                    {([
                      { c: 'bg-purple-200 border-purple-400', l: '>4' },
                      { c: 'bg-red-200 border-red-400', l: '3–4' },
                      { c: 'bg-yellow-100 border-yellow-300', l: '2–3' },
                      { c: 'bg-green-100 border-green-300', l: '1–2' },
                      { c: 'bg-sky-100 border-sky-300', l: '≤1' },
                      { c: 'bg-background-50 border-background-300', l: '无' },
                    ]).map((x) => (
